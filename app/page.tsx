...
export default function TerraVIIMasterPage() {
  const [activeTab, setActiveTab] = useState<
    'home' | 'about' | 'philosophy' | 'expeditions' | 'dossier' | 'gallery' | 'journal' | 'booking' | 'contact' | 'faq'
  >('home');
      ...
      <div className="pt-28">
        ...
        {activeTab === 'philosophy' && (
          <main className="max-w-7xl mx-auto px-6 md:px-12 py-12 space-y-12">
            ...
            <h1 className="font-heading text-4xl md:text-6xl uppercase tracking-widest">TRANSFORMATION OVER TOURISM</h1>
